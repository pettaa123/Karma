...
GameWindow {
    ...
    readonly property string gameTitle: "Karma"
    ...
    readonly property int gameTokens : 0  // tokens are our game currency from in-app purchase store
    ...
    FelgoGameNetwork {
        ...
        property bool enableMultiUserSimulation: false
    ...
    Loader {
        ...
        Timer {
            id: loadingTimer
            interval: 500
            onTriggered: sceneLoader.source = Qt.resolvedUrl("ShitheadMainItem.qml")
        }
    }
